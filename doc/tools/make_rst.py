...
this_file = "doc/tools/make_rst.py"

# Version stub
version = {}

# BEGIN copied imports from color.py
...
# END copied imports from color.py
...
def make_rst_class(class_def: ClassDef, state: State, dry_run: bool, output_dir: str) -> None:
    ...
    with open(
        ...
        source_github_url = f"{github_url}/tree/{git_branch}/{source_xml_path}"
        generator_github_url = f"{github_url}/tree/{git_branch}/{this_file}"
